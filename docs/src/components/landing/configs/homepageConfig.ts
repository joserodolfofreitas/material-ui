...
export const heroConfig: HomepageHeroConfig = {
  ...
  description:
    'Build better products with UI that helps people do their best work, powered by customizable components, advanced building blocks, and AI-native workflows.',
